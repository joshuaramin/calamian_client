            ...
            <form onSubmit={onHandleUpdateForm}>
                <div className={styles.ss}>
                    <div>
                        ...
                        <input className={styles.inp} type="text" value={mItems.items} onChange={(e) => setMItems({ ...mItems, items: e.target.value })} />
                    </div>
                    <div>
                        <label className={oxygen.className}>Dosage</label>
                        <input className={styles.inp} type="text" value={mItems.dosage} onChange={(e) => setMItems({ ...mItems, dosage: e.target.value })} />
                    </div>
                    <div>
                        <label className={oxygen.className}>Price</label>
                        <input className={styles.inp} type="text" placeholder={Intl.NumberFormat("en-PH", { style: "currency", currency: "PHP" }).format(price)} onChange={(e) => setMItems({ ...mItems, price: e.target.value })} />
                    </div>

                    <div>
                        <label className={oxygen.className}>Quantity</label>
                        <input className={styles.inp} type="text" value={mItems.quantity} onChange={(e) => setMItems({ ...mItems, quantity: e.target.value })} />
                    </div>
                    <div>
