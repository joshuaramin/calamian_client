...
export const DeleteUser = gql`
  mutation DeleteUserAccount($userId: ID!, $main: ID!) {
...
export const ResetDefaultPassword = gql`
...
export const UpdateUserAccounts = gql`
  mutation UpdateUserAccounts($userId: ID!, $user: userInput) {
...
export const UpdateUserEmailAddress = gql`
  mutation UpdateUserPassword($email: EmailAddress!, $userId: ID!) {
